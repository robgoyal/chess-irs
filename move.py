...
class Move:
    ...
    def prettify_board(self):
        ...
        numbered_board = [f"{row_num}|{row}|{row_num}" for row, row_num
                          in zip(str(self.previous_state).split("\n"), range(8, 0, -1))]
...
if __name__ == "__main__":
    board = chess.Board()
    m = Move(board, "/Users/robing/Desktop/51604156_1512333872231521_6941479307176837120_n.jpg",
                "/Users/robing/Desktop/blob1.jpg")
    test_map = m.new_color_map
    test_map[6][3], test_map[4][3] = test_map[4][3], test_map[6][3]

    print(m.determine_move())
