...
from . import utils, debug, deps

import collections
import cv2, numpy as np
import scipy, scipy.cluster
from neuralchessboard.config import *

from keras.models import model_from_json

__laps_model = 'neuralchessboard/data/models/laps.model.json'
__laps_weights = 'neuralchessboard/data/models/laps.weights.h5'
